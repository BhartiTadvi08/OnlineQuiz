        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('post.create') }}" class="btn btn-success btn-sm" title="Add New Customer">
                            ...
                            <table class="table">
                                ...
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td>{!!$item->comment!!}</td>
                                        <td>
                                            <a href="{{route('post.show',$item->id)}}" title="View Customer">
                                            	<button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button>
                                            </a>
                                            <a href="{{route('post.edit',$item->id)}}" title="Edit Customer">
                                            	<button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
                                            </a>

                                            <form method="POST" action="{{route('post.delete',$item->id)}}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
